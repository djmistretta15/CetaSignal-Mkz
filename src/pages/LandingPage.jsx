...
export default function LandingPage({ onStart, sessionScore, roundsPlayed, onLeaderboard, onBack }) {
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-5 border-b border-ocean-700/30">
        ...
        <div className="flex items-center gap-4">
          {onBack && (
            <button onClick={onBack} className="flex items-center gap-2 glass px-4 py-2 text-sm text-ocean-300 hover:text-ocean-100 transition-colors">
              <span className="font-display">← RESEARCH</span>
            </button>
          )}
          {roundsPlayed > 0 && (
